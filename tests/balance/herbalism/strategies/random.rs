...
/// Random strategy: picks a uniformly random card from playable herbalism cards.
/// Serves as the baseline — expected lowest yield per durability due to frequent
/// over-elimination (0 plants remaining = loss).
