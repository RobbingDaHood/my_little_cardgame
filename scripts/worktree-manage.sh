...
# Worktrees are created as sibling directories under ../my_little_cardgames/
...
Commands:
  ...
  add <name>          Create a new worktree at ../my_little_cardgames/<name>
...
Examples:
  $(basename "$0") add wt1
  $(basename "$0") reset wt1
  $(basename "$0") remove wt1
EOF
}
